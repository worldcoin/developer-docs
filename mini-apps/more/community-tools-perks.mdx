...
<CardGroup cols={2}>
  <Card
    ...
    icon="cube"
    href="https://docs.google.com/forms/d/e/1FAIpQLSfgjLhpcUlocct1KwXapL326CDUQ1zOCEudyF5WO4RAD-wn7A/viewform"
  >
    Ongoing rewards program for Mini App builders based on verified human
    usage. Your Mini App must already be live in World App to apply.
  </Card>
