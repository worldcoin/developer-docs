...
Invite-code mode creates a random 6-digit code that the user enters into World App during account creation. World App uses the code to customize the in-app onboarding so the user adds a credential that can satisfy your IDKit request.
