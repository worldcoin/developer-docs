...
<CardGroup cols={1}>
  ...
  <Card title="Bot prevention">
    Block bots and AI agents at sign-up or on any action. Request a liveness-verified credential - Face for low-friction flows, Proof of Human for maximum assurance. No CAPTCHAs, no phone numbers needed.
  </Card>
</CardGroup>
