...
| `world_app_permission_not_enabled` | The permission is disabled at the World App level; prompt the user to enable it in World App settings |
| `mini_app_permission_not_enabled` | The permission is disabled at the mini app level; prompt the user to enable it in World App settings |
