...
Find places to use AgentKit in the [AgentBook registry](https://github.com/andy-t-wang/agentbook) (the agentbook.world frontend is down; query status on-chain with `npx @worldcoin/agentkit-cli status`).
