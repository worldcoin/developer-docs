...
Already have an app configured and just need the integration steps spelled out? Use the
[standalone integration prompt](/world-id/idkit/integration-prompt) instead.
