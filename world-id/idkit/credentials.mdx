...
Selfie Check is available through the legacy preset today and returns a World ID 3.0 Face proof. World ID 4.0 support is rolling out soon. Learn more in [Selfie Check](/world-id/credentials/11). 

<Note>
  Selfie Check is currently in beta. If you're interested in using or learning more about Selfie Check, please [contact us](mailto:developers@toolsforhumanity.com).
</Note>
