...
description: "Verify World ID proofs in your backend using the Developer Portal API; hashing signals, REST endpoints, and request examples."
...
Find the full API reference [here](/api-reference/developer-portal/verify-legacy).
