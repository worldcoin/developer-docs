...
description: "OIDC-based Sign in with World ID: discovery, authorize, token exchange, OAuth2 endpoints, introspect, and userinfo."
---
...
<Note>
  ...
  base64 encoding of the "client_id:client_secret" values. You obtain your
  client_id (also called app_id) and client_secret from the Developer Portal.
</Note>
