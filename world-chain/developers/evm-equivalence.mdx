...
<Note type="info">These are on-chain configuration values that change over time. You can always find the current values in the [Superchain Registry](https://github.com/ethereum-optimism/superchain-registry/blob/main/superchain/configs/mainnet/worldchain.toml).</Note>
