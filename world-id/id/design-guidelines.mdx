...
<img
  src="/images/docs/id/design-guidelines/main.png"
  alt="Default state - Waiting for user to scan the QR code"
  width="600"
  height="400"
...
<img
  src="/images/docs/id/design-guidelines/success.png"
  alt="Success - Successful connection"
  width="600"
  height="400"
  className="w-full h-auto max-w-[600px]"
/>
...
<img
  src="/images/docs/id/design-guidelines/lost.png"
  alt="Connection lost - Lost connection to server or user offline"
  width="600"
  height="400"
  className="w-full h-auto max-w-[600px]"
/>
...
<img
  src="/images/docs/id/design-guidelines/error.png"
  alt="Error - Generic technical error or proof failure"
  width="600"
  height="400"
  className="w-full h-auto max-w-[600px]"
/>
...
<img
  src="/images/docs/id/design-guidelines/partner.png"
  alt="Partnership example"
  width="600"
  height="400"
  className="w-full h-auto max-w-[600px]"
/>
...
>
  <div className="p-4 bg-gradient-to-br from-gray-50 to-gray-100">
    <img
      src="/images/docs/id/design-guidelines/human-verified-badge.svg"
      alt="Human badge"
      width="24"
      height="24"
