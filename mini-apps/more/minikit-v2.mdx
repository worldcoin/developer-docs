...
**New:** Verification works as a mini app and standalone. The widget will only work in web, you should add branching logic to show it only outside of World App.
```ts
