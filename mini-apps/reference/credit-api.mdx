...
<Note>
This endpoint requires authorization. Unauthenticated requests, including the example below, currently receive `401 Unauthorized`. Contact the Credit team (see [Support](#support)) to get access before integrating.
</Note>
