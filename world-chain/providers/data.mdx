...
## [GoldSky](https://goldsky.com/) Subgraphs
...
GoldSky Subgraphs is a data indexing service designed to simplify querying blockchain data. It provides developers with scalable, customizable subgraphs for
 ...
 offering a user-friendly interface and advanced APIs that help developers query blockchain data faster and more accurately. See the [GoldSky docs](https://docs.goldsky.com/) for more information.
