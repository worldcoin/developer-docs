...
Agent Kit lets an x402 server recognize when a request comes from an agent backed by a World ID-verified human. Use this page for the shortest path to a working integration. Check out the full [SDK Reference](/agents/agent-kit/sdk-reference) for more details.
