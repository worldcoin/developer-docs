...
Authentication failures use JSON-RPC error code `-32001`. The message distinguishes missing or malformed credentials from a key that was parsed but rejected:
