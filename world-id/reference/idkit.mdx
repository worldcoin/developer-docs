...
description: "Reference for IDKit React and Standalone: components, hooks, Session API, verifyCloudProof, types, and advanced config."
...
<Properties>
  ...
  <Property name="onSuccess" type="function(ISuccessResult)" required={true}>
    ...
    [the proof details.](#isuccessresult)
  </Property>
  <Property name="handleVerify" type="function(ISuccessResult)">
    ...
    details.](#isuccessresult) Throwing an error in this screen will show the user a
    custom error.
    <Note>
  ...
  <Property
    name="bridge_url"
    type="string"
    defaultValue='"https://bridge.worldcoin.org"'
  >
...
<Properties>
  ...
  <Property
    name="endpoint"
    type="URL | string"
    defaultValue="https://developer.worldcoin.org/api/v2/verify/${app_id}"
  >
