...
<div className="mb-6">
  <a
    ...
    className="block w-full rounded-lg border border-blue-200 bg-blue-50 px-4 py-3 text-blue-900 hover:bg-blue-100 hover:no-underline focus:outline-none focus:ring-2 focus:ring-blue-400"
  ...
  >
    <div className="flex items-center gap-3">
      ...
      <span className="ml-auto text-blue-700 underline">Register</span>
    </div>
  </a>
</div>
