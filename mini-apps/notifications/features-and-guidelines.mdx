...
<div className="flex justify-center">
  <img src="/images/docs/mini-apps/notifications/notification-badges.jpg" alt="Notification Interface in the Developer Portal" className="m-auto block" width="300" />
</div>
</div>
