  ...
  <div className="not-prose mt-5">
    <div className="grid gap-10 md:grid-cols-3">
      ...
      <a href="/world-id/credentials/11" className="block no-underline transition-transform duration-200 hover:-translate-y-0.5">
        ...
        <h3 className="mt-5 mb-0 text-xl font-medium text-zinc-900 dark:text-zinc-100">Selfie Check</h3>
...
<Visibility for="agents">
  ...
  - [Selfie Check](/world-id/credentials/11) — Low-friction liveness and uniqueness signal from a selfie flow. Best for sign-up and bot defense where speed matters most.
</Visibility>
