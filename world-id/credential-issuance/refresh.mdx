...
- When refreshing with a PCP, `claims[0]` and `associated_data_hash` are derived from the PCP `hashes.json` bytes.
...
- [PoH credential structure (Notion)](https://www.notion.so/worldcoin/WIP-World-ID-Issuers-Credential-Structures-2ca8614bdf8c80c5b1cbfdd7d6becb61?source=copy_link#2ca8614bdf8c80879d9dcd770734ae41)
