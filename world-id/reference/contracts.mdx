...
<Note>
  Orb credentials use `groupId` `1`. The router does route additional groups on-chain, but they aren't RP-facing.
</Note>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td className="p-2 align-middle">
        Determines which Credential Type to verify against. Orb credentials
        are <code>1</code> — the only RP-facing group; the router does route
        others on-chain.
      </td>
    </tr>
    <tr>
