...
The sandbox build is available on **both** the Google Play testing track and Firebase
App Distribution — use whichever you prefer.

1. Open the invite/download link we provide for your chosen channel.
2. Follow the link to install the **World ID (Sandbox)** build.

If you install via Firebase App Distribution, you may be prompted to install the App
Tester helper the first time.
...
integration flows. (Testing those flows is covered in a separate guide.)
