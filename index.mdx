...
{/*
  ...
  export). Markup is inlined rather than imported from /snippets because Mintlify
  inlines imported component source into the Markdown export. Keep the twin's
  links and copy in sync when editing.
*/}
...
<div style={{ marginBottom: "192px" }}>
  {(() => {
    /* Developer stories carousel per the Docs 3.0 homepage design (previously
       /snippets/developer-stories.jsx): horizontally scrolling 16:9 video cards
       with a play button and a name / role / company chip. Clicking a card swaps
       the poster for a privacy-enhanced YouTube embed. Mintlify's MDX runtime
       does not forward React refs to elements here, so the arrows locate the
       track from the clicked button instead of a ref. */
    const stories = [
      {
        name: "Diego Estevez",
        role: "Co-Founder",
      ...
      return (
        <div className="not-prose" data-developer-stories>
          <div className="flex flex-wrap items-end justify-between gap-4">
            <div>
              <div className="landing-section-title">Developer stories</div>
              <div className="landing-section-sub">See how developers build trusted, human-centered apps with World.</div>
            </div>
