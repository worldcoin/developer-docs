...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td className="p-2 align-middle whitespace-nowrap"><code>selfieCheckLegacy</code></td>
      <td className="p-2 align-middle"><strong>Deprecated.</strong> Returns the World ID 3.0 Selfie Check proof. Keep it only for an existing legacy integration; use <a href="#selfie-check"><code>selfieCheck</code></a> for new integrations.</td>
    </tr>
    <tr>
