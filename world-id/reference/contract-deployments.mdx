...
description: "Addresses for World ID Router and related contracts across Ethereum, World Chain, Optimism, Polygon, and Base."
...
<table>
  <thead>
    <tr>
      <th className="p-2 text-left align-middle">Contract</th>
      <th className="p-2 text-left align-middle">Base Mainnet</th>
  ...
  <tbody>
    <tr>
      <td className="p-2 align-middle">World ID Router</td>
      <td className="p-2 align-middle">
        <a href="https://basescan.org/address/0xBCC7e5910178AFFEEeBA573ba6903E9869594163#code">
          0xBCC7e591…4163
        </a>
      </td>
      <td className="p-2 align-middle">
    ...
    <tr>
      <td className="p-2 align-middle">Bridged World ID</td>
      <td className="p-2 align-middle">
        <a href="https://basescan.org/address/0x13F5788c3CE48911bca120C9e197fBdFED8bEBf3#code">
          0x13F5788c…EBf3
        </a>
      </td>
      <td className="p-2 align-middle">
