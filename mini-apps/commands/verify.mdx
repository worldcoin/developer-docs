...
The verify command lets you use [incognito actions](/world-id/idkit/getting-started) inside of your mini app. Incognito actions are a primitive of World ID and allow you to gate functionality behind a unique human check.
