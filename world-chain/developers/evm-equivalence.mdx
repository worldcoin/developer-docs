...
<Note type="info">These parameters are on-chain configuration values that change over time (for example, as gas limits are raised). You can always find the current values in the [Superchain Registry](https://github.com/ethereum-optimism/superchain-registry/blob/main/superchain/configs/mainnet/worldchain.toml).</Note>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td className="p-2 align-middle">See [Superchain Registry](https://github.com/ethereum-optimism/superchain-registry/blob/main/superchain/configs/mainnet/worldchain.toml)</td>
