...
<div className="grid grid-cols-1 items-start gap-6 lg:grid-cols-2">
  <div>
    <img
      src="/images/docs/mini-apps/guidelines/main-pages-1.png"
      alt="One clear task per page"
    />
  ...
  <div>
    <img
      src="/images/docs/mini-apps/guidelines/main-pages-2.png"
      alt="Keep CTAs visible"
    />
    <p className="text-muted-foreground mt-2 text-sm">
  ...
  <div>
    <img
      src="/images/docs/mini-apps/guidelines/main-pages-4.png"
      alt="Minimize unnecessary scrolling"
    />
    <p className="text-muted-foreground mt-2 text-sm">
  ...
  <div>
    <img
      src="/images/docs/mini-apps/guidelines/main-pages-5.png"
      alt="Prioritize primary actions"
    />
    <p className="text-muted-foreground mt-2 text-sm">
