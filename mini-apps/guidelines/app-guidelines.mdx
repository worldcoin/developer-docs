...
<div className="grid grid-cols-2">
  <div className="grid justify-items-center text-center">
    <video className="m-auto" width="300" autoPlay muted loop playsInline>
      <source
        src="/images/docs/mini-apps/guidelines/bad-compressed.mp4"
        type="video/mp4"
      />
  ...
  <div className="grid justify-items-center text-center">
    <video className="m-auto" width="300" autoPlay muted loop playsInline>
      <source
        src="/images/docs/mini-apps/guidelines/good-compressed.mp4"
        type="video/mp4"
      />
      Your browser does not support the video tag.
    </video>
...
<div className="grid justify-items-center text-center">
  <img
    ...
    width="345"
    height="240"
    src="/images/docs/mini-apps/guidelines/content-card-image.png"
    alt="Good content card example"
  />
  ✅ Good Example <br />
  <br />
</div>
...
- [Package README](https://www.npmjs.com/package/@worldcoin/mini-apps-ui-kit-react?activeTab=readme)
  href="https://www.npmjs.com/package/@worldcoin/mini-apps-ui-kit-react?activeTab=readme"
  target="\_blank"
  > Package README
