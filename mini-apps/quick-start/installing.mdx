...
If you scan the QR code to open your mini app and nothing happens make sure you've properly configured the supported countries settings in the Developer Portal > Configuration > Mini App Store 
