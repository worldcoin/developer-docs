---
title: "Send Transaction v1"
description: "Legacy v1 MiniKit send transaction flow."
...
<div className="grid justify-items-center text-center">
	<video className="m-auto" width="300" autoPlay muted loop playsInline>
		<source src="/images/docs/mini-apps/commands/transaction.mp4" type="video/mp4" />
...
To get precise debug information, you can fetch debug URLs (Tenderly) using the [Get Transaction Debug URL](/api-reference/developer-portal/get-transaction-debug-url) endpoint.
