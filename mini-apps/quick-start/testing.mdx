...
<Visibility for="humans">
  <QRCodeGenerator baseUrl="https://world.org/mini-app" />
</Visibility>

<Visibility for="agents">
  To test on a phone, open `https://world.org/mini-app?app_id=<your_app_id>` (the docs page renders this link as a scannable QR code):
