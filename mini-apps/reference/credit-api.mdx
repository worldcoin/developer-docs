...
<Note>
This endpoint requires authorization; unauthenticated requests, including the example below, receive `401 Unauthorized`. Contact the [Credit team](#support) for access before integrating.
</Note>
