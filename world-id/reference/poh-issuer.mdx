...
| `claims` | `FieldElement[]` | Up to 15 claim commitments (the 16th slot is reserved internally and stripped on deserialization). Unused indices are the zero field element. |
