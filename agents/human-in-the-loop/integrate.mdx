...
- [Flight booking example](https://github.com/worldcoin/human-in-the-loop/tree/main/examples/flight-booking) — Full end-to-end app with action-bound approvals
- [Server package source](https://github.com/worldcoin/human-in-the-loop/tree/main/packages/human-in-the-loop) — `requestHumanAuthorization` implementation
- [React package source](https://github.com/worldcoin/human-in-the-loop/tree/main/packages/human-in-the-loop-react) — `<HumanApproval>` and `useHumanApproval`
