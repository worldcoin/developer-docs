...
<CardGroup cols={2}>
  <Card title="World Docs MCP" icon="book-open" href="/mcp/world-docs">
    Search World documentation from Claude, Codex, Cursor, VS Code, and other MCP clients. No API key required.
  </Card>
  <Card title="Developer Portal MCP" icon="key" href="/mcp/developer-portal">
...
| --- | --- | --- |
| [World Docs MCP](/mcp/world-docs) | You want your AI assistant to search World docs while editing code. | None |
| [Developer Portal MCP](/mcp/developer-portal) | You want your AI assistant to manage apps in the World developer portal. | Developer portal team API key |
