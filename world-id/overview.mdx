...
<div className="not-prose space-y-12">
        ...
        {[
          ...
          >
            <div className="flex items-start justify-between gap-4">
              ...
              <span className="mt-1 inline-flex h-7 w-7 items-center justify-center rounded-full border border-[#e4e4e4] text-gray-400 transition-all group-hover:translate-x-1 group-hover:border-gray-300 group-hover:text-gray-600">→</span>
            </div>
          </a>
        ))}
      </div>
  ...
  <section className="mt-10">
    ...
    {[
      ...
      <div key={title} className="rounded-[12px] border border-[#e7e7e7] bg-white p-5 text-center transition-all hover:-translate-y-0.5 hover:shadow-[0_10px_26px_rgba(15,23,42,0.06)]">
