...
Selfie Check is available through the legacy preset today and returns a World ID 3.0 proof. World ID 4.0 support is rolling out soon. Learn more in [Selfie Check](/world-id/credentials/11).
