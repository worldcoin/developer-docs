...
- If the account has just signed in to Google Play for the first time, Google may need
  time to recognize the new account. Wait before opening the testing link again.
- If you still cannot access or install the build, contact
