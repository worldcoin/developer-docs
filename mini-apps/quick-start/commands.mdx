...
<Note>
  ...
  Legacy v1 docs are still available for
  [Wallet Authentication v1](/mini-apps/commands/wallet-auth-v1) and
  [Send Transaction v1](/mini-apps/commands/send-transaction-v1).
</Note>
