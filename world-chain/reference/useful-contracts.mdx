...
See the [World ID on-chain verification guide](/world-id/idkit/onchain-verification) for deployments across supported chains, and the [Address Book reference](/mini-apps/reference/address-book) for `WorldIDAddressBook`.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td className="p-2 align-middle">SwapRouter02</td>
      <td className="p-2 align-middle">
    ...
    <tr>
      <td className="p-2 align-middle">NftDescriptorLibraryAddressV1_3_0</td>
      <td className="p-2 align-middle">
