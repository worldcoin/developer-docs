  ...
  <div className="not-prose mt-5">
    <div className="grid gap-10 md:grid-cols-3">
      ...
      <a href="/world-id/credentials/11" className="block no-underline transition-transform duration-200 hover:-translate-y-0.5">
        ...
        {/* Mintlify wraps heading children in its own span, so the badge alignment lives on this inner span, not on the h3. */}
        <h3 className="mt-5 mb-0 text-xl font-medium text-zinc-900 dark:text-zinc-100"><span className="inline-flex flex-wrap items-center gap-x-2 gap-y-1"><span>Selfie Check</span> <span className="rounded-lg bg-blue-400/20 px-1.5 py-0.5 text-sm leading-5 font-semibold text-blue-700 dark:bg-blue-400/20 dark:text-blue-300">Beta</span></span></h3>
