...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td className="p-2 align-middle">ezETH/ETH</td>
      <td className="p-2 align-middle">
...
This feed reports the ezETH redemption rate against ETH, not a USD price. To
derive a USD price for ezETH, multiply this rate by a separate ETH/USD feed
